...
export default {
    ...
    dashboard: {
        ...
        competitionSelect: {
            title: "Welcome to OriLive Dashboard",
            startBySelectingCompetition: "Start by selecting a competition",
        ...
        devices: {
            ...
            failedToRemoveDevice: "Failed to remove device due to an unknown error.",
        },
        oresults: {
            title: "OResults integration",
            unitsMapped: "devices mapped to OResults",
            mapNewDevice: "Map new device",
            localID: "Local ID",
            oresultsApiKey: "OResults API key",
        ...
        punches: {
            title: "Punches",
            punchesInLastHour: "punches in the last hour",
            minutesSinceLastPunch: "minutes since last punch",
        ...
        networkCommands: {
            ...
            activeCommands: "active network commands",
            competitionId: "Competition ID",
            commandType: "Type",
            commandData: "Data",
            creationTime: "Creation time",
            addCommand: "Create network command",
            commandTypeLong: "Command type",
            createCommandButton: "Create",
            commandAdded: "Command successfully created.",
            unknownErrorOccurred: "Unknown error occurred.",
        },
        createCompetition: {
            baseInformation: "Basic information",
            additionalInformation: "Additional information",
            someInformationMissing: "Some information is missing.",
            optional: "Optional",
            createdSuccessfully: "Competition created successfully.",
            createAnother: "Create another",
            createCompetition: "Create competition",
            next: "Next",
            generalInformation: "General information about the competition",
            competitionName: "Competition name *",
            competitionNameHelper:
                "Enter the name of the competition, which will be displayed on the website.",
            ...
            additionalInformationTitle: "Additional information about the competition",
            competitionDescription: "Competition description",
            competitionLocation: "Competition location",
            competitionOrganizer: "Organizing team",
            expectedEndDate: "Expected end date of the competition",
            backButtonText: "Back",
            backToSelection: "Back to competition selection",
        },
    },
